...
namespace Morito
{
    public class CollisionEngine
    {
        ...
        public void resolveCollision(int A, int B)
        {
            ...
            float ma = Collidables[A].Mass;
            float mb = Collidables[B].Mass;

            float vxa = Collidables[A].Velocity.X;
            float vya = Collidables[A].Velocity.Y;
            float vxb = Collidables[B].Velocity.X;
            float vyb = Collidables[B].Velocity.Y;

            float xa = Collidables[A].Position2D.X;
            float ya = Collidables[A].Position2D.Y;
            float xb = Collidables[B].Position2D.X;
            float yb = Collidables[B].Position2D.Y;
            ...
            isPhysicsable AA = Collidables[A];
            isPhysicsable BB = Collidables[B];
