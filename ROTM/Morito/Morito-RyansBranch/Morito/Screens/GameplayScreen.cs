...
namespace Morito.Screens
{
    ...
    public class GameplayScreen : GameScreen
    {
        ...
        List<CombatText> _combatTextList = new List<CombatText>();
        ...
        public List<CombatText> CombatTextList
        {
            get { return _combatTextList; }
            set { _combatTextList = value; }
        }
 ...
 + "CurrentPlayerNumber:" + CurrentPlayerNumber);
        ...
        public override void LoadContent()
        {
            ...
            if (players >= 1)
            {
                ...
                Player1 = new HumanPlayer(this, new Vector3(40, 40, 0)) { PlayersIndex = PlayerIndex.One };
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // TODO: Delete once stats are 100%
            DisplayedMessages["bulletsfired1"] = "P1 Bullets Fired: " + Player1.ShotsFired;
            DisplayedMessages["hitstaken1"] = "P1 Hits from bullets: " + Player1.HitsTaken;
            DisplayedMessages["asteriods1"] = "P1 Collisions with Asteriods: " + Player1.AsteriodsHit;
            ...
            // draw combat text
            foreach (CombatText textItem in _combatTextList)
            {
                textItem.Draw(this, gameTime);
                if ((textItem.ExpireTime) == gameTime.TotalGameTime.Seconds)
                {
                    _combatTextList.Remove(textItem);
                    break;
                }
            }
        }
