...
namespace Morito
{
    public class CollisionEngine
    {
        ...
        { 
            _collidables = new List<isCollidable>();
            globalMessages = MoritoFighterGame.MoritoFighterGameInstance._screenManager.DisplayedMessages;
        }
        ...
        public void update()
        {
            ...
            {
                for (int y = x; y < _collidables.Count; y++)
                {
                    if (x != y)
                    {
